...
[images/binary.jpg](images/binary.jpg) is the binarised result after preprocessing. [images/2D_FFT_magnitude.jpeg](images/2D_FFT_magnitude.jpeg) is the centered, log-compressed two-dimensional magnitude spectrum (jet) whose dominant peaks define the thread angles. [images/rotated_binary_warp.jpg](images/rotated_binary_warp.jpg) is the cleaned binary after rotation by the recovered warp angle, aligning warp threads vertically. [images/vertical_mask.jpg](images/vertical_mask.jpg) is the warp counting mask. [images/rotated_binary_weft.jpg](images/rotated_binary_weft.jpg) is the cleaned binary after rotation by the recovered weft angle, aligning weft threads horizontally. [images/horizontal_mask.jpg](images/horizontal_mask.jpg) is the weft counting mask produced by directional erosion.
